      ...
      children: [
        {
          ...
          meta: { title: 'Gestiones', permission: 'app_gestiones' } // Access logic handled inside component or via more complex guard if needed
        },
        // Solicitudes
        {
        ...
        },
        {
          ...
          meta: { title: 'Bandeja de Solicitudes (Admin)', permission: 'asignar_solicitudes-administrativas' }
        },
        {
          path: 'solicitudes/:id',
        ...
        },
        {
          ...
          meta: { title: 'Mis Asignaciones (Admin)', permission: 'seguimiento_solicitudes-administrativas' }
        },
        {
