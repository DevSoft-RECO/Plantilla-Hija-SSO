...
<template>
    <div class="p-4 sm:p-6 h-[calc(100dvh-80px)] md:h-[calc(100vh-80px)] overflow-hidden flex flex-col">
        <div class="flex justify-between items-center mb-4 sm:mb-6 flex-shrink-0">
            <div>
                <h1 class="text-xl sm:text-2xl font-bold text-white">Bandeja de Solicitudes Administrativas</h1>
                <p class="text-xs sm:text-sm text-white/70">Gestión de casos administrativos</p>
            </div>
        </div>
        ...
        <div class="hidden sm:flex flex-1 bg-white/10 backdrop-blur-md rounded-xl shadow-2xl border border-white/20 overflow-hidden flex-col">
            ...
            <div class="p-4 border-t border-gray-100 border-white/10 flex justify-between items-center bg-gray-50 dark:bg-gray-800/50">
