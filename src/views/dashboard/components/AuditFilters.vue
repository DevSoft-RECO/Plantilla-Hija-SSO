    ...
    <div class="div1 px-0 py-0 shrink-0 bg-white/10 backdrop-blur-md flex flex-col md:flex-row md:items-center rounded-2xl shadow-2xl relative transition-all border border-white/20">
        ...
        <div class="flex-1 flex flex-col md:flex-row gap-4 md:gap-6 min-w-0 py-3 px-5 overflow-x-auto custom-scrollbar md:items-center">
            ...
            <div class="relative shrink-0 min-w-[160px]">
                ...
                <select v-model="localFiltros.tipo" class="w-full text-sm bg-white/10 text-white border border-white/20 rounded-xl focus:ring-2 focus:outline-none pl-9 py-2 pr-3 transition-all hover:bg-white/20 cursor-pointer shadow-inner backdrop-blur-sm" style="--tw-ring-color: var(--color-azul-cope)">
            ...
            <div class="relative shrink-0 min-w-[160px]">
                ...
                <select v-model="localFiltros.estado" class="w-full text-sm bg-white/10 text-white border border-white/20 rounded-xl focus:ring-2 focus:outline-none pl-9 py-2 pr-3 transition-all hover:bg-white/20 cursor-pointer shadow-inner backdrop-blur-sm" style="--tw-ring-color: var(--color-azul-cope)">
            ...
            <div class="relative flex-1 shrink-0 min-w-[200px] max-w-xs">
                ...
                <select v-model="localFiltros.agencia_id" class="w-full text-sm bg-white/10 text-white border border-white/20 rounded-xl focus:ring-2 focus:outline-none pl-9 py-2 pr-3 transition-all hover:bg-white/20 cursor-pointer shadow-inner backdrop-blur-sm" style="--tw-ring-color: var(--color-azul-cope)">
